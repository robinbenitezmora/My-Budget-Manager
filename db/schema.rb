...
ActiveRecord::Schema[7.0].define(version: 2023_01_05_021447) do
  ...
  add_foreign_key "associations", "clusters", column: "start_id"
  add_foreign_key "associations", "starts", column: "cluster_id"
